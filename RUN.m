...
[rf,pcashape]=cache(@train,images,masks,shapes,1); %pcashape enth�lt PCA der 30 Trainingsbilder (pcashape=[shapesmean,shapeseVal,shapeseVec])
...
%laufzeiten geringer.. fehler h�her.. boxplot mit beiden vektoren
%variieren der baumtiefe, min/max, opt-dauer (=h�ufigkeit)